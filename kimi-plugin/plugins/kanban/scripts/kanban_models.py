...
Claude, Codex, Grok, and Kimi plugins' review_pr.py.
...
This module ships in five homes, held byte-identical the way `kanban_config.py`'s
...
`grok-plugin/plugins/kanban/scripts/kanban_models.py`, and
...
and must load the reader from beside itself. The Claude, Grok, and Kimi
