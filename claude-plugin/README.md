...
housekeeping audit, and the `/autosolve` autonomous solve-and-review loop,
each rendered
...
`kanban@kanban` should be listed, and all twenty-five workflow names should be
...
`/project-review`, `/drain-prs`, `/fix`, `/finalize`, `/janitor`, and
`/autosolve`.
...
- the marketplace and plugin manifests are valid and point at this
  directory;
- the commands directory contains exactly the twenty-five packaged workflows,
