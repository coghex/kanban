...
- That notification may direct the user to Codex's `$kanban:drain-prs`;
  `{{cmd:drain-prs}} recover` controls the same incident and is equivalent from
  Claude.
<!-- brand:codex -->
